import { title, violetColor } from "@/components/primitives";
...
export default function DashboardPage() {
  return (
    <div>
      ...
      <h2 className={"text-2xl mt-3 " + violetColor}>Reports</h2>
      <p className="mt-2">
      ...
      <h2 className={"text-2xl mt-3 " + violetColor}>Raw Data</h2>
      <p className="mt-2">
      ...
      <h2 className={"text-2xl mt-3 " + violetColor}>Upload</h2>
      <p className="mt-2">
      ...
      <h2 className={"text-2xl mt-3 " + violetColor}>Settings</h2>
      <p className="mt-2">
